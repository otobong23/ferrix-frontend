  ...
  return (
    <div>
      <div className='py-5 px-6 flex items-center gap-4 bg-[#44474F] rounded-lg mx-4 my-4'>
        ...
        <div>
          <h1 className='text-[#F5F5F7] font-bold text-2xl'>User_9847266</h1>
      ...
      <div className="grid grid-cols-3 gap-6 px-4 mb-4">
        {
          profile_links.map(link => (
            <Link key={link.name} href={link.href} className="flex flex-col items-center justify-center gap-0.5 theme-button-effect">
      ...
      <div className="px-4">
        ...
        <div className="flex flex-col bg-[#2F3033] px-4 py-3 rounded-lg gap-4 mb-2.5">
          {
            security_center.map(link => (
              <Link key={link.name} href={link.href} className="flex items-center gap-1.5 theme-button-effect">
        ...
        <div className="flex flex-col bg-[#2F3033] px-4 py-3 rounded-lg gap-4 mb-2.5">
          <Link href="/" className="flex items-center gap-1.5 theme-button-effect">
            <Icon icon="iconamoon:profile-circle-fill" width={24} />
            <p className="text-xl">ID Setup</p>
            <Icon icon="weui:arrow-outlined" width="12" height="24" className="ml-auto text-[#9EA4AA]" />
          </Link>

          <button className="flex items-center gap-1.5 theme-button-effect">
