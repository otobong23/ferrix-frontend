...
const WithdrawalPassword = () => {
   ...
   const [form_inputs, setForm_inputs] = useState([
      ...
      { name: 'confirm_withdrawal_password', label: 'Confirm Withdrawal Password', type: 'password', placeholder: '*******', required: true },
   ])
   ...
   return (
      <div>
         <UI_header title="Wallet Password" description="Wallet Security, Top Priority" />
