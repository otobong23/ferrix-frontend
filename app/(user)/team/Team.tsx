      ...
      <div className=''>
         ...
         <div className='px-4 mb-8'>
            ...
            <div className='bg-[#2F3033] rounded-lg px-4 py-[13px] pb-7'>
               ...
               <div className='px-2.5 py-[9px] bg-[#F5F5F7]/7 rounded-sm flex justify-between items-center'>
                  <p className='text-[#F5F5F7] text-sm w-3/5'>https://ferrix.app/pages/register?ref={referralCode}</p>
                  <button onClick={() => handleCopy(`https://ferrix.app/pages/register?ref=${referralCode}`, setCopied2)} className='w-[100px] py-[5px] bg-[#9EA4AA] rounded-xs text-black'>{copied2 ? "Copied!" : "Copy"}</button>
               </div>
            </div>
         </div>
